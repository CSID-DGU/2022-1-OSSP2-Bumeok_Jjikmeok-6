...
public class Asura : Boss_Info
{
    ...
    IEnumerator Pattern01()
    {
        ...
        Launch_Weapon_For_Move_Blink(Weapon[1], Vector3.zero, Quaternion.Euler(new Vector3(0, 0, -9)), 0, false, new Vector3(0, -4.5f, 0));
    ...
    IEnumerator Pattern05()
    {
        ...
        for (int i = 0; i < 2; i++)
            yield return StartCoroutine(Change_Color_Return_To_Origin(Color.white, new Color(159 / 255, 43 / 255, 43 / 255), 0.5f, false));
