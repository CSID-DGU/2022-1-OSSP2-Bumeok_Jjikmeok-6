...
public class EnemyAndBossSpawn : MonoBehaviour
{
    ...
    IEnumerator First_Boss_Appear()
    {
        ...
        yield return StartCoroutine(Boss.GetComponent<DoPhan>().Position_Lerp(Boss.transform.position, new Vector3(6.3f, Boss.transform.position.y, Boss.transform.position.z), 2.5f, OriginCurve));
